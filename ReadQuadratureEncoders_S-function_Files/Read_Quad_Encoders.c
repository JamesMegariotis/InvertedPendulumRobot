 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sun Jul 24 14:18:01 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Read_Quad_Encoders
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void Read_Quad_Encoders_Outputs_wrapper(real_T *x1,
			real_T *x2,
			const real_T *xD,
			const uint8_T  *enc, const int_T  p_width0,
			const uint8_T  *pinA, const int_T  p_width1,
			const uint8_T  *pinB, const int_T  p_width2);
extern void Read_Quad_Encoders_Update_wrapper(const real_T *x1,
			const real_T *x2,
			real_T *xD,
			const uint8_T  *enc,  const int_T  p_width0,
			const uint8_T  *pinA,  const int_T  p_width1,
...
{
    real_T        *x1  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *x2  = (real_T *)ssGetOutputPortRealSignal(S,1);
    ...
    Read_Quad_Encoders_Outputs_wrapper(x1, x2, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    Read_Quad_Encoders_Update_wrapper(x1, x2,  xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
